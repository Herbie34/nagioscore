...
like( $output, "/<td CLASS='optBoxRequiredItem'>コメント ID:</td>/", "$local_cgi with cmd_typ=$cmd_typ requires Comment ID field" );
unlike( $output, "/Sorry, but no information is available for this command./", "$local_cgi with cmd_typ=$cmd_typ has a command description" );
...
like( $output, "/<td CLASS='optBoxRequiredItem'>ホスト名:</td>/", "$local_cgi with cmd_typ=$cmd_typ requires Host Name in form" );
like( $output, "/<td CLASS='optBoxRequiredItem'>サービス名:</td>/", "$local_cgi with cmd_typ=$cmd_typ requires Service in form" );
like( $output, "/<td CLASS='optBoxRequiredItem'>通知を遅らせる時間\\(現在からの分\\):</td>/", "$local_cgi with cmd_typ=$cmd_typ requires Notification Delay form" );
unlike( $output, "/Sorry, but no information is available for this command./", "$local_cgi with cmd_typ=$cmd_typ has a command description" );
...
like( $output, "/<td CLASS='optBoxRequiredItem'>コメント:</td>/", "$local_cgi with cmd_typ=$cmd_typ requires Comment in form" );
like( $output, "/<td CLASS='optBoxItem'>既知の問題を固定:</td>/", "$local_cgi with cmd_typ=$cmd_typ allows Sticky Acknowledge in form" );
like( $output, "/<td CLASS='optBoxItem'>警報を通知:</td>/", "$local_cgi with cmd_typ=$cmd_typ allows to send notification in form" );
like( $output, "/<td CLASS='optBoxItem'>再起動後もコメントを保持させる:</td>/", "$local_cgi with cmd_typ=$cmd_typ allows to set Persistent Comment in form" );
unlike( $output, "/Sorry, but no information is available for this command./", "$local_cgi with cmd_typ=$cmd_typ has a command description" );
...
like( $output, "/<td CLASS='optBoxRequiredItem'>ダウンタイム ID:</td>/", "$local_cgi with cmd_typ=$cmd_typ requires Scheduled Downtime ID in form" );
unlike( $output, "/Sorry, but no information is available for this command./", "$local_cgi with cmd_typ=$cmd_typ has a command description" );
